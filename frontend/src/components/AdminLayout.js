    ...
    <div className="d-flex" style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      >
        ...
        <ul className="nav nav-pills flex-column gap-1 mb-auto">
          ...
          <li><a href="/admin/quan-ly-lich-hoc" className={`nav-link ${location.pathname.includes('/quan-ly-lich-hoc') ? 'active bg-info' : 'text-white-50'}`}><i className="bi bi-calendar-week me-2"></i> Quản lý lịch học</a></li>
          <li><a href="/admin/lich" className={`nav-link ${location.pathname.includes('/lich') && !location.pathname.includes('/quan-ly-lich-hoc') ? 'active bg-info' : 'text-white-50'}`}><i className="bi bi-calendar-event me-2"></i> Quản lý buổi học</a></li>      
