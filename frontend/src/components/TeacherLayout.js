            ...
            <div className="position-relative">
              ...
              >
                <div className="text-muted small me-2">
                  Xin chào, <b style={{ color: '#495057' }}>{teacherData?.hoTen || gvName || 'Giảng viên'}</b>
                </div>
                {teacherData?.anhThe && !avatarError ? (
                  ...
                  >
                    {teacherData?.hoTen ? teacherData.hoTen.charAt(0).toUpperCase() : (gvName ? gvName.charAt(0).toUpperCase() : 'G')}
                  </div>
                )}
